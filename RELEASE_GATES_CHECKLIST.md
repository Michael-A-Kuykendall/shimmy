...
### Documentation
- [ ] `CHANGELOG.md` has a complete section for the exact requested version
...
- [ ] Release notes are the matching `CHANGELOG.md` section, not only an
      autogenerated commit list
- [ ] Patch/minor/major increment follows the maintainer's explicit release
      decision; do not infer the increment from change size
- [ ] GitHub release page displays the notes and expected platform assets
